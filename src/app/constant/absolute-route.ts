...
export const ABS_ACCOUNT_LOGIN = `/${routes.LOGIN}`;
...
export const ABS_LEAVEDETAIL=`/${routes.LAYOUT}/${routes.LEAVE}/${routes.LEAVEDETAIL}`;
...
export const ABS_DSRDETAIL=`/${routes.LAYOUT}/${routes.DSR}/${routes.DSRDETAIL}`;
