...
export const sideNavList = [
  ...
  { title: 'Enterpreneurship Program', logo: 'person',routerLink:'hweiuewiuieu', options: [{ subTitle: 'Explore', subLogo: 'horizontal_rule' },], isActiv: true, },
  ...
  { title: 'Reviews', logo: 'grid_view',routerLink:'hweiuewiuieu', options: [{ subTitle: 'Explore', subLogo: 'horizontal_rule' }], isActiv: true, },
